...
class RecipesProvider extends ChangeNotifier {
  final List<Recipe> _recipes = recipeExamples.map((e) => Recipe.fromMap(e)).toList();
...
final List<Map<String, dynamic>> recipeExamples = [{
  ...
  "description": "A delicious and nutritious stir-fry loaded with tender chicken and colorful vegetables, seasoned with savory sauces.",
  "durationInMins": 30,
